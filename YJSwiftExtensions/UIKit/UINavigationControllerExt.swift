...
extension UINavigationController {
    /// 替换当前导航控制器栈顶的视图
    public func replaceTop(with viewController: UIViewController, animated: Bool = true) {
...
extension UINavigationController {
    ...
    class func swizzle() {
        ...
        DispatchQueue.once(token: onceToken) {
            let needSwizzleSelectorArr = [NSSelectorFromString("_updateInteractiveTransition:"), #selector(popToViewController), #selector(popToRootViewController)
            ]
